...
namespace WordDocClassLibraryOpenXml.Docs
{
    ...
    /// <summary>
    /// //Свидетельства о поверке. Форма 1
    /// </summary>
    internal class СertificateVer1
    {
        СertificateDTO _dTO;
        public СertificateVer1(СertificateDTO dTO)
        {
            this._dTO = dTO;
        }

        public void CreateСertificateV1()
        {
            try
            {
                    ...
                    = WordprocessingDocument.Create(_dTO.FileName, WordprocessingDocumentType.Document))
                {
                    ...
                    TabExtension2.ChangeText(t, n, 0, "Средство измерений");
                    ...
                    TabExtension2.DelCellBorder(t, n, 1, false);
                    TabExtension2.ChangeText(t, n, 0, "модификация, регистрационный номер в Федеральном информационном фонде по обеспечению единства измерений, " +
                        "серия и номер знака предыдущей поверки (если такие серия и номер имеются)");
                    n++;
                    TabExtension2.DelCellBorder(t, n, 0);
                    TabExtension2.ChangeText(t, n, 0, "Заводской номер");
                    ...
                    TabExtension2.DelCellBorder(t, n, 0);
                    TabExtension2.DelCellBorder(t, n, 1);
                    TabExtension2.ChangeText(t, n, 1, "наименование величин, диапазонов, на которых поверено средство измерений (если предусмотрено методикой поверки)");
                    n++;
                    TabExtension2.DelCellBorder(t, n, 0);
                    ...
                    n++;
                    TabExtension2.DelCellBorder(t, n, 0);
                    TabExtension2.ChangeText(t, n, 0, "с применением эталонов:");
                    TabExtension2.DelCellBorder(t, n, 1, true, false);
